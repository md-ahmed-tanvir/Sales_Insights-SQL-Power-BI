...
Data subset collected in [SQL dump file](https://github.com/md-ahmed-tanvir/Sales_Insights-SQL-Power-BI/blob/main/Sales_Insights-SQL-Power-BI/Database%20dump.sql) and loaded to SQL server for exploring the data tables.
Tables:
1. Customers
2. Date
3. Markets
...
[click here to view code](https://github.com/md-ahmed-tanvir/Sales_Insights-SQL-Power-BI/blob/main/Sales_Insights-SQL-Power-BI/Data%20Cleaning%20%26%20Exploration%20using%20SQL.sql)

### Analysis using SQL
[Click here to view code](https://github.com/md-ahmed-tanvir/Sales_Insights-SQL-Power-BI/blob/main/Sales_Insights-SQL-Power-BI/Data%20Analysis%20using%20SQL.sql)
Queries:
